...
import searchImage from './PixabayServices';
import type { Pixabay } from './types';

export type AddSelected_1 = (selectedImagesURL: string[]) => void;

type Props = {
  addSelected_1: AddSelected_1
};

export default function PixabayBrowser(props:Props) {
  const [pokemonImages, setImages] = useState<Pixabay.Result[]>([]);
  ...
  return (
    <Stack data-testid="pixabay-browser" sx={{ height: '100%' }}>
